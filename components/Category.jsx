...
export default function CategoryCard() {
  return (
    <div className="w-fit rounded-lg flex flex-col justify-center items-center  bg-white border border-gray-200  hover:shadow-slate-500  shadow-md dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
